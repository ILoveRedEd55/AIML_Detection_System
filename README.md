...
To download these dependencies, install the '**requirements.txt**' in the '**config**' folder. To do this, navigate to the '**config**' folder using your **cmd terminal** and type the following:
```
